package com.example.waterwaveview.view;
...
public class WaterWaveView extends View {
    ...
    private void init() {
        ...
        progressPaint.setColor(Color.parseColor("#ff5383a4"));
        ...
        circlePaint.setColor(Color.parseColor("#ffe4e4a6"));

        circleBg=new Paint();
        circleBg.setAntiAlias(true);
        circleBg.setColor(Color.parseColor("#ffe4e4a6"));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(centerX,centerY,VALID_RADIUS,circleBg);
        ...
        textPaint.getTextBounds("T", 0, 1, textBounds);
        float h2 = textBounds.height();
        canvas.drawText("T", centerX + w1 / 2 - extraW + 5, centerY - (h1 / 2 - h2), textPaint);
...
//        canvas.drawText(text4, centerX - w4 / 2, centerY - (VALID_RADIUS >> 1) + h4 / 2, textPaint);
    ...
    private Path getWavePath(int xOffset) {
        ...
        Log.d("startpoint0",String.valueOf(startPoint[0]));
        Log.d("startpoint1",String.valueOf(startPoint[1]));
        if (wavePath.isEmpty()) {
